...
module.exports = {
    ...
    USERNAME: process.env.USERNAME || 'Ahmad Ali',
    SESSION: process.env.SESSION || 'Raganork~c15efbc21c2835b931eb1eec55ff46fc:70336d792b737a356b51303d',
    ...
    ALLOWED: process.env.ALLOWED || '92,686,94,91,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '/#!$&.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Ikratos-md',
    ...
    SUDO: process.env.SUDO || '923470027813,0,68673025589,0',
